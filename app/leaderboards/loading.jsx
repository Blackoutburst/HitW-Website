            ...
            {[...Array(10).keys()].map((index) => (
                <div className={`w-full p-4 shadow-lg ${index == 0 ? "lg:rounded-t-lg border-t lg:border-x" : index == 9 ? "lg:rounded-b-lg border-b lg:border-x" : 'lg:border-x' } ${index % 2 == 0 ? "bg-[#404040] border-[#606060]" : "bg-[#303030] border-[#505050]"}`}>
                    <div className="flex w-full items-center justify-between">
                        ...
                        <div className="bg-gray-500 w-12 h-8 lg:w-16 lg:h-10 rounded-xl animate-pulse"/>
                            <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gray-500 animate-pulse rounded-xl" />
                            <div className="bg-gray-500 w-32 lg:w-48 h-8 lg:h-10 rounded-xl animate-pulse"/>
                        </div>
                        <div className="bg-gray-500 w-16 lg:w-24 h-8 lg:h-10 rounded-xl animate-pulse"/>
                    </div>
                </div>
            ))}
        </div>
